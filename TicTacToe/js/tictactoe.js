...
function checkWinConditions() {
    ...
    // O 0,4,8 condition
    else if (arrayIncludes('0O', '4O', '8')) { drawLine(100, 100, 520, 520) }
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variables we pass are al included in our array then
...
function drawLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
    //This line indicates where the start of a lones y axis is
    y1 = coordY1,
    ...
    function clear() {
        //This line starts our loop animation
